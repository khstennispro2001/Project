...
final class Simulation
{
	...
	private static final float LEFT_RIGHT_VELOCITY=(float) 30.0;
	private static final float UP_DOWN_VELOCITY=(float) 30.0;
	private static final float MAX_FORWARD_VELOCITY=(float) 60.0;
	private static final float MAX_BACKWARD_VELOCITY=(float) 30.0;
	...
	private static final float ACCELERATION=(float) 100.0;
